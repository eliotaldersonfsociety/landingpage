        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 text-center order-2 lg:order-1">
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-balance">
                <b>THE CUTEST GIFT PEOPLE DIDN'T <span className="text-orange-500">KNOW THEY WANTED</span></b>
            </h1>

            <p className="text-xs text-muted-foreground text-pretty">
              Ships fast from Hot Springs, TX 🇺🇸. Trusted by customers across Texas
            </p>
            <div className="flex items-center gap-8 pt-4 justify-center">
              <div className="flex flex-col items-center gap-1">
                <Truck className="h-8 w-8 text-orange-500" />
                <div className="text-sm text-muted-foreground">Ships fast from Hot Springs, TX</div>
              </div>
              <div className="flex flex-col items-center gap-1">
                <Package className="h-8 w-8 text-orange-500" />
                <div className="text-sm text-muted-foreground">1 business days delivery</div>
              </div>
              <div className="flex flex-col items-center gap-1">
                <ShieldCheck className="h-8 w-8 text-orange-500" />
                <div className="text-sm text-muted-foreground">Pay with PayPal — buyer protection included</div>
              </div>
            </div>
          ...
          >
            {/* CTA principal */}
            <span className="text-[22px] md:text-[24px] font-extrabold tracking-wide">
              GET YOUR LABUBU
            </span>
            {/* Urgencia suave */}
            <span className="text-[11px] opacity-80 tracking-wide">
            ...
            {/* Seguridad / pago */}
            <span className="text-[12px] opacity-95 tracking-wide flex items-center gap-1">
              <Lock/>
              Secure checkout with <strong>PayPal</strong>
            </span>

            {/* Envío */}
            <span className="text-[12px] opacity-90 tracking-wide flex items-center gap-1">
              <Truck/>
              Ships from <strong>Hot Springs, TX</strong> · 1 day
            </span>
